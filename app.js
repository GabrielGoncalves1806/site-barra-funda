...
const AREA_DETAILS = {
  academia: {
    ...
    image: "assets/area-academia.jpg",
    highlights: [
  ...
  lavanderia: {
    ...
    image: "assets/area-lavanderia.jpg",
    highlights: [
  ...
  playground: {
    ...
    image: "assets/area-playground.jpg",
    highlights: [
      "Horário 8h às 22h",
  ...
  churrasqueira: {
    ...
    image: "assets/area-churrasqueira.jpg",
    highlights: [
  ...
  coworking: {
    ...
    image: "assets/area-coworking.jpg",
    highlights: [
      "Horário 7h às 22h",
  ...
  bicicletario: {
    ...
    image: "assets/area-bicicletario.jpg",
    highlights: [
...
function renderSales(sales) {
  ...
  activeSales.forEach(item => {
    ...
    card.innerHTML = `
      <img class="sale-card__image" src="${item.image}" alt="${item.title}" onerror="this.src='assets/placeholder-sale.svg'" />
